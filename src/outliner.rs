...
use rustemo::lr::parser::Action::{self, Accept, Error, Reduce, Shift};
...
const TERMINAL_COUNT: usize = 24usize;
const NONTERMINAL_COUNT: usize = 26usize;
const STATE_COUNT: usize = 64usize;
#[allow(dead_code)]
...
impl std::fmt::Debug for State {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            State::CommentLineS43 => "43:CommentLine",
            State::OCommentS44 => "44:OComment",
            State::LayoutS45 => "45:Layout",
            State::LayoutItem1S46 => "46:LayoutItem1",
            State::LayoutItem0S47 => "47:LayoutItem0",
            State::LayoutItemS48 => "48:LayoutItem",
            State::CommentS49 => "49:Comment",
            State::ModelCommentS50 => "50:ModelComment",
            State::IDS51 => "51:ID",
            State::NotCommentS52 => "52:NotComment",
            State::CommentS53 => "53:Comment",
            State::Cornc1S54 => "54:Cornc1",
            State::Cornc0S55 => "55:Cornc0",
            State::CorncS56 => "56:Cornc",
            State::LayoutItemS57 => "57:LayoutItem",
            State::StartCommentKWS58 => "58:StartCommentKW",
            State::CorncS59 => "59:Cornc",
            State::CCommentS60 => "60:CComment",
            State::TillEndCommentKWS61 => "61:TillEndCommentKW",
            State::TillEndCommentKWOptS62 => "62:TillEndCommentKWOpt",
            State::EndCommentKWS63 => "63:EndCommentKW",
        };
        write!(f, "{name}")
    }
}
...
pub(crate) static PARSER_DEFINITION: OutlinerParserDefinition = OutlinerParserDefinition {
    actions: [
        ...
        [
            ...
            Error,
            Shift(State::CommentLineS43),
            Shift(State::OCommentS44),
            Error,
            Error,
        ],
        [
        ...
        [
            ...
            Shift(State::TillEndCommentKWS61),
            Error,
            Error,
            Error,
            Error,
    ...
    gotos: [
        ...
        [
            ...
            None,
            None,
            Some(State::LayoutS45),
            Some(State::LayoutItem1S46),
            Some(State::LayoutItem0S47),
            Some(State::LayoutItemS48),
            Some(State::CommentS49),
            None,
            None,
            Some(State::ModelCommentS50),
            None,
            None,
        ],
        [
        ...
        [
            ...
            None,
            None,
            Some(State::CommentS53),
            Some(State::Cornc1S54),
            Some(State::Cornc0S55),
            None,
            None,
            Some(State::CorncS56),
        ],
        ...
        [
            ...
            None,
            None,
            Some(State::TillEndCommentKWOptS62),
            None,
        ],
        [
            None, None, None, None, None, None, None, None, None, None, None, None, None, None,
...
impl<'i, L: Lexer<Input, TokenRecognizer>> OutlinerParser<L> {
    ...
    #[allow(clippy::needless_lifetimes)]
    pub fn parse(&self, input: &'i Input) -> Result<<DefaultBuilder as Builder>::Output> {
...
pub struct OutlinerLayoutParser(
    LRParser<State, ProdKind, TokenKind, NonTermKind, OutlinerParserDefinition, TokenRecognizer>,
);
...
impl<'i> LRBuilder<'i, Input, ProdKind, TokenKind> for DefaultBuilder {
    ...
    fn shift_action(&mut self, context: &mut Context<'i>, token: Token<'i, Input, TokenKind>) {
        let val = match token.kind {
            TokenKind::STOP => panic!("Cannot shift STOP token!"),
            TokenKind::OBrace => Terminal::OBrace(outliner_actions::obrace(context, token)),
            TokenKind::CBrace => Terminal::CBrace(outliner_actions::cbrace(context, token)),
            TokenKind::ComponentKW => {
                Terminal::ComponentKW(outliner_actions::component_kw(context, token))
            }
            TokenKind::ConfigurationKW => {
                Terminal::ConfigurationKW(outliner_actions::configuration_kw(context, token))
            }
            TokenKind::CodeKW => Terminal::CodeKW(outliner_actions::code_kw(context, token)),
            TokenKind::EndCodeKW => {
                Terminal::EndCodeKW(outliner_actions::end_code_kw(context, token))
            }
            TokenKind::ModelKW => Terminal::ModelKW(outliner_actions::model_kw(context, token)),
            TokenKind::LibraryKW => {
            ...
            TokenKind::TillEndCodeKW => {
                Terminal::TillEndCodeKW(outliner_actions::till_end_code_kw(context, token))
            }
    ...
    fn reduce_action(&mut self, context: &mut Context<'i>, prod: ProdKind, _prod_len: usize) {
        let prod = match prod {
            ProdKind::ModelP1 => {
                let mut i = self
                    .res_stack
                ...
                match (
                    ...
                    ) => NonTerminal::Model(outliner_actions::model_c1(
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Configuration(p0)) => {
                        NonTerminal::ConfigurationOpt(
                            outliner_actions::configuration_opt_configuration(context, p0),
                        )
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            ...
            ProdKind::ConfigurationOptP2 => {
                NonTerminal::ConfigurationOpt(outliner_actions::configuration_opt_empty(context))
            }
            ProdKind::ModelOrLibraryP1 => {
                let mut i = self
                    ...
                    .into_iter();
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::ModelKW(p0)) => NonTerminal::ModelOrLibrary(
            ...
            ProdKind::ModelOrLibraryP2 => {
                let mut i = self
                    ...
                    .into_iter();
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::LibraryKW(p0)) => NonTerminal::ModelOrLibrary(
            ...
            ProdKind::ElementP1 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Component(p0)) => {
                        NonTerminal::Element(outliner_actions::element_component(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::ElementP2 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Handler(p0)) => {
                        NonTerminal::Element(outliner_actions::element_handler(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::ElementP3 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Block(p0)) => {
                        NonTerminal::Element(outliner_actions::element_block(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::Element0P1 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Element1(p0)) => {
                        NonTerminal::Element0(outliner_actions::element0_element1(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ...
            ProdKind::Element1P1 => {
                ...
                match (i.next().unwrap(), i.next().unwrap()) {
                    ...
                    ) => NonTerminal::Element1(outliner_actions::element1_c1(context, p0, p1)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::Element1P2 => {
                ...
                match i.next().unwrap() {
                    Symbol::NonTerminal(NonTerminal::Element(p0)) => {
                        NonTerminal::Element1(outliner_actions::element1_element(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::ComponentP1 => {
                ...
                match (
                    ...
                    ) => NonTerminal::Component(outliner_actions::component_c1(
            ...
            ProdKind::IDOptP2 => NonTerminal::IDOpt(outliner_actions::idopt_empty(context)),
            ProdKind::ConfigurationP1 => {
                ...
                match (i.next().unwrap(), i.next().unwrap()) {
                    ...
                    ) => NonTerminal::Configuration(outliner_actions::configuration_c1(
                        context, p0, p1,
                    )),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            ...
            ProdKind::BlockP1 => {
                ...
                match (i.next().unwrap(), i.next().unwrap(), i.next().unwrap()) {
                    ...
                    ) => NonTerminal::Block(outliner_actions::block_c1(context, p0, p1, p2)),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::HandlerP1 => {
                ...
                match (
                    ...
                    (
                        ...
                        NonTerminal::Handler(outliner_actions::handler_c1(context, p0, p1, p2, p3))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::TillEndCodeKWOptP1 => {
                let mut i = self
                    ...
                    .into_iter();
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::TillEndCodeKW(p0)) => NonTerminal::TillEndCodeKWOpt(
                        outliner_actions::till_end_code_kwopt_till_end_code_kw(context, p0),
                    ),
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::TillEndCodeKWOptP2 => {
                NonTerminal::TillEndCodeKWOpt(outliner_actions::till_end_code_kwopt_empty(context))
            }
            ProdKind::TypeNameP1 => {
                let mut i = self
                    .res_stack
                ...
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::Name(p0)) => {
                        NonTerminal::TypeName(outliner_actions::type_name_name(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
            ProdKind::TypeNameP2 => {
                ...
                match i.next().unwrap() {
                    Symbol::Terminal(Terminal::ID(p0)) => {
                        NonTerminal::TypeName(outliner_actions::type_name_id(context, p0))
                    }
                    _ => panic!("Invalid symbol parse stack data."),
                }
            }
