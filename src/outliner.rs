...
impl std::fmt::Display for State {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            State::AnythingS34 => "34:Anything",
            State::CommentLineS35 => "35:CommentLine",
            State::OCommentS36 => "36:OComment",
            State::LayoutS37 => "37:Layout",
            State::LayoutItem1S38 => "38:LayoutItem1",
            State::LayoutItem0S39 => "39:LayoutItem0",
            State::LayoutItemS40 => "40:LayoutItem",
            State::CommentS41 => "41:Comment",
            State::NotCommentS42 => "42:NotComment",
            State::CommentS43 => "43:Comment",
            State::Cornc1S44 => "44:Cornc1",
            State::Cornc0S45 => "45:Cornc0",
            State::CorncS46 => "46:Cornc",
            State::LayoutItemS47 => "47:LayoutItem",
            State::CorncS48 => "48:Cornc",
            State::CCommentS49 => "49:CComment",
        };
        write!(f, "{name}")
    }
}
...
pub(crate) static PARSER_DEFINITION: OutlinerParserDefinition = OutlinerParserDefinition {
    actions: [
        ...
        [
            ...
            Error,
            Error,
            Shift(State::AnythingS34),
            Error,
            Shift(State::CommentLineS35),
            Shift(State::OCommentS36),
            Error,
            Error,
        ],
        [
    ...
    gotos: [
        ...
        [
            ...
            None,
            None,
            Some(State::LayoutS37),
            Some(State::LayoutItem1S38),
            Some(State::LayoutItem0S39),
            Some(State::LayoutItemS40),
            Some(State::CommentS41),
            None,
            None,
            None,
        ],
        ...
        [
            ...
            Some(State::Cornc1S44),
            Some(State::Cornc0S45),
            Some(State::CorncS46),
        ],
        [
            None,
...
pub struct OutlinerLayoutParser(
    LRParser<State, ProdKind, NonTermKind, OutlinerParserDefinition, TokenRecognizer>,
);
