...
const NONTERMINAL_COUNT: usize = 22usize;
    ...
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            ProdKind::ModelCommentP1 => {
                "ModelComment: CommentKW ID StartCommentKW TillEndCommentKW EndCommentKW"
            }
...
impl std::fmt::Display for State {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            State::IDS27 => "27:ID",
            State::IDOptS28 => "28:IDOpt",
            State::EndCodeKWS29 => "29:EndCodeKW",
            State::OBraceS30 => "30:OBrace",
            State::Element0S31 => "31:Element0",
            State::CBraceS32 => "32:CBrace",
            State::AUGLS33 => "33:AUGL",
            State::CommentKWS34 => "34:CommentKW",
            State::ModelPropertyS35 => "35:ModelProperty",
            State::ConfigurationPropertyS36 => "36:ConfigurationProperty",
            State::AnythingS37 => "37:Anything",
            State::StringS38 => "38:String",
            State::CommentLineS39 => "39:CommentLine",
            State::OCommentS40 => "40:OComment",
            State::LayoutS41 => "41:Layout",
            State::LayoutItem1S42 => "42:LayoutItem1",
            State::LayoutItem0S43 => "43:LayoutItem0",
            State::LayoutItemS44 => "44:LayoutItem",
            State::CommentS45 => "45:Comment",
            State::ModelCommentS46 => "46:ModelComment",
            State::IDS47 => "47:ID",
            State::NotCommentS48 => "48:NotComment",
            State::CommentS49 => "49:Comment",
            State::Cornc1S50 => "50:Cornc1",
            State::Cornc0S51 => "51:Cornc0",
            State::CorncS52 => "52:Cornc",
            State::LayoutItemS53 => "53:LayoutItem",
            State::StartCommentKWS54 => "54:StartCommentKW",
            State::CorncS55 => "55:Cornc",
            State::CCommentS56 => "56:CComment",
            State::TillEndCommentKWS57 => "57:TillEndCommentKW",
            State::EndCommentKWS58 => "58:EndCommentKW",
        };
        write!(f, "{name}")
    }
}
...
pub(crate) static PARSER_DEFINITION: OutlinerParserDefinition = OutlinerParserDefinition {
    actions: [
        ...
        [
            ...
            Error,
            Error,
            Shift(State::CommentKWS34),
            Error,
            Error,
            Error,
            Error,
            Error,
            Shift(State::ModelPropertyS35),
            Shift(State::ConfigurationPropertyS36),
            Shift(State::AnythingS37),
            Shift(State::StringS38),
            Error,
            Shift(State::CommentLineS39),
            Shift(State::OCommentS40),
            Error,
            Error,
        ],
        [
        ...
        [
            ...
            Error,
            Error,
            Shift(State::TillEndCommentKWS57),
            Error,
            Error,
            Error,
            Error,
    ...
    gotos: [
        ...
        [
            ...
            None,
            None,
            Some(State::LayoutS41),
            Some(State::LayoutItem1S42),
            Some(State::LayoutItem0S43),
            Some(State::LayoutItemS44),
            Some(State::CommentS45),
            None,
            None,
            Some(State::ModelCommentS46),
            None,
        ],
        [
            None,
        ...
        [
            ...
            Some(State::Cornc1S50),
            Some(State::Cornc0S51),
            None,
            Some(State::CorncS52),
        ],
        [
...
impl Default for OutlinerLayoutParser {
    fn default() -> Self {
        Self(LRParser::new(&PARSER_DEFINITION, State::AUGLS33, true))
    }
}
#[allow(dead_code)]
#[derive(Debug)]
