...
const STATE_COUNT: usize = 57usize;
#[allow(dead_code)]
const MAX_ACTIONS: usize = 8usize;
...
impl std::fmt::Display for State {
    fn fmt(&self, f: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
        let name = match self {
            ...
            State::AnythingS35 => "35:Anything",
            State::StringS36 => "36:String",
            State::CommentLineS37 => "37:CommentLine",
            State::OCommentS38 => "38:OComment",
            State::LayoutS39 => "39:Layout",
            State::LayoutItem1S40 => "40:LayoutItem1",
            State::LayoutItem0S41 => "41:LayoutItem0",
            State::LayoutItemS42 => "42:LayoutItem",
            State::CommentS43 => "43:Comment",
            State::ModelCommentS44 => "44:ModelComment",
            State::IDS45 => "45:ID",
            State::NotCommentS46 => "46:NotComment",
            State::CommentS47 => "47:Comment",
            State::Cornc1S48 => "48:Cornc1",
            State::Cornc0S49 => "49:Cornc0",
            State::CorncS50 => "50:Cornc",
            State::LayoutItemS51 => "51:LayoutItem",
            State::StartCommentKWS52 => "52:StartCommentKW",
            State::CorncS53 => "53:Cornc",
            State::CCommentS54 => "54:CComment",
            State::TillEndCommentKWS55 => "55:TillEndCommentKW",
            State::EndCommentKWS56 => "56:EndCommentKW",
        };
        write!(f, "{name}")
    }
}
...
pub struct OutlinerParserDefinition {
    ...
    token_recognizers: [[Option<TokenRecognizer>; 8usize]; STATE_COUNT],
}
pub(crate) static PARSER_DEFINITION: OutlinerParserDefinition = OutlinerParserDefinition {
    actions: [
        ...
        [
            ...
            Error,
            Error,
            Shift(State::AnythingS35),
            Shift(State::StringS36),
            Error,
            Shift(State::CommentLineS37),
            Shift(State::OCommentS38),
            Error,
            Error,
        ],
        [
        ...
        [
            ...
            Error,
            Error,
            Shift(State::TillEndCommentKWS55),
            Error,
            Error,
            Error,
            Error,
    ...
    gotos: [
        ...
        [
            ...
            None,
            None,
            Some(State::LayoutS39),
            Some(State::LayoutItem1S40),
            Some(State::LayoutItem0S41),
            Some(State::LayoutItemS42),
            Some(State::CommentS43),
            None,
            None,
            Some(State::ModelCommentS44),
            None,
        ],
        [
            None,
        ...
        [
            ...
            None,
            None,
            Some(State::CommentS47),
            Some(State::Cornc1S48),
            Some(State::Cornc0S49),
            None,
            Some(State::CorncS50),
        ],
        [
